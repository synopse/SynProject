...
(*
    ...
    Synopse SynProject. Copyright (C) 2008-2018 Arnaud Bouchez
...
uses
  ...
  ProjectEditor, ProjectParser, ProjectSections;
...
begin
  ...
  DotOK := true;
  OriginalContent := Source.Lines.Text;
  btnRefreshClick(nil);
...
procedure TGraphEditForm.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  if (ModalResult<>mrOk) and (OriginalContent<>Source.Lines.Text) then
